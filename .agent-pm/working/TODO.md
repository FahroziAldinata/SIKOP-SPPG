...
- ✅ **Task gabungan SELESAI + APPROVED 2026-08-12**: **isolasi test dari data kerja nyata** — gabungan GF-013 (suite jalan di DB dev sama) + GF-014 T2 risiko (test mutasi user seed nyata + restore cost 10). Akar sama persis: test tidak terisolasi. 5 file test refactor → user test sendiri (create beforeAll, delete afterAll), cost 12, cleanup by ID. Verifikasi: 673 test SEMUA PASS, user seed utuh, SystemConfig utuh, lint 0 error. Laporan: `.agent-pm/plans/2026-08-12-isolasi-test-dari-data-seed.md` (232 baris).
