    ...
    <div style={{ padding: '10px' }}>
      ...
      <div style={{ border: '1px solid var(--border)', borderRadius: 'var(--radius-md)', padding: '20px', backgroundColor: 'var(--bg-elevated)', width: '30%' }}>
        ...
        <div style={{ display: 'flex', gap: '15px', flexWrap: 'wrap' }}>
          ...
          <button onClick={() => navigate('/gizi/target-gizi')} style={{ padding: '10px 20px', backgroundColor: '#16a34a', color: '#fff', border: 'none', borderRadius: '4px', cursor: 'pointer', fontWeight: 'bold' }}>Target Gizi</button>
